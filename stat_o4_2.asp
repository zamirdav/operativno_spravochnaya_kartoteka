...
db.Open "ATOC1"   
Name_Zad="ATOC_o4_1"   
pSlv="n2_211"   'гражданство   изменяя словарь получишь другую статистику
POLE="r11"       'изменяя поле получишь другую статистику
...
sub SPISOK_PRINT
   Response.Write "<TABLE border=><TR><TD>гражданство<TD>всего"
   S=1
   KOL=0
   Do while S<999
      ...
      ZNA=MAC(S)
      if ZNA>0 then
         ZNA="<A href='STAT_o4_2.asp?ORGAN=" & S & "'>&nbsp;<FONT size=+1>" & ZNA & "</FONT>&nbsp;</A>"
