...
if N = "1" then 
   Response.Redirect "all-form.asp?T=1"
end if 
if N = "2" then 
   Response.Redirect "all-form.asp?T=2"
end if 
if N = "0" then 
   ...
   if P=D1 then
      ...
      Response.Write "<A href='all-form.asp?T=1'> по ФИО </A><BR>"
      Response.Write "<A href='all-form.asp?T=2'> по УД </A><BR>"
      Response.Write "<BR>"
      Response.Write "<BR>"
      Response.Write "<BR>"
