...
if NOT Rs.EOF then
   ...
   Call Vid_MP  ("N арх",       "ZZ5", "2")
   Call Vid_MP  ("дакто",       "ZZ6", "3")
...
'      Call Vid_RekM ("дата пресечения", 	"ZZ4")
      ...
      Call Vid_MgMp ("ст УК",            	"18", "9")
      Call Vid_MgMp ("п",         		"P1", "10")
'      Call Vid_RekMexe("орган", 	    	"O", "<A href='dop-poisk.asp?N="&N & "</A>")  
      ...
      Call Vid_MgMp ("п",         		"471", "11")
      Call Vid_RekM ("Доп квал 1",		"48")
      Call Vid_MgMp ("п",         		"481", "12")
      Call Vid_RekM ("Доп квал 2",		"49") 
      Call Vid_MgMp ("п",         		"491", "13")
      Call Vid_MgMp ("доп меры нак", 		"55", "8")
      Call Vid_RekM ("дата приг", 		"44") 
      Call Vid_RekM ("суммма штрафа",     	"52") 
      Call Vid_MgMp ("содерж ИТУ",   		"31", "14")
