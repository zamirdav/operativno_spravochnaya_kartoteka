...
db.Open "ATOC1"   
Name_Zad="ATOC_o4_1"   
pSlv_BOK="N1_213"   'изменяя словарь получишь другую статистику 
pSlv_SAP="N2_216"   'изменяя словарь получишь другую статистику 
BOK="r13"       'изменяя поле получишь другую статистику
SAP="rzz3"



dim MAC(200,36) ' эти цифры ставь обязательно из кол-ва строк словарей словарей 
...
'      Response.Write ZAPROS & "<BR>"
   ...
   if db.Errors.Count > 0 then
      ...
      Do while NOT Rs.EOF 
         ...
         if K<1 then K=36      	'KOLONOK
         if S>200 then S=200 	'STROK
         if K>36 then K=36	'KOLONOK
         MAC(S,K)=MAC(S,K)+1
         Rs.MoveNext          
      Loop                    
end sub
